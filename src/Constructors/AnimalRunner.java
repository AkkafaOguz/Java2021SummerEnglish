...
public class AnimalRunner {
		...
		public static void main(String[] args) {                    
			...
			System.out.println(Animal.counter);//3      You have use the class name the where you get the class variable, because you are in TR and you should go to USA to see your house!
		}
