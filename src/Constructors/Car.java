...
public class Car {
	...
	public static void main(String[] args) {
		...
		// When you want to look at the value of a class variable no need to use
		// objects.
		System.out.println(soldCarCounter);// 5 if you get the variable that belongs to this class, you do not have to use the object name to get it.  You are already in USA!
