...
//To initialize is optional
	/*
	 * class variables(static variables) are attached to the class, not to the
	 * object
	 */
	...
	public static void main(String[] args) {
		 ...
		 * Because, main method is static and static methods do not accept non-static
		 * things in it.
		 */
	...
	public int add(int a, int b) {
		...
		/*
		 * When you try to use instance variable inside any non-static method, it is
		 * fine.
		 */
		System.out.println(c);
